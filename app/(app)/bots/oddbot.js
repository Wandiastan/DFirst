class OddBot {
    ...
    analyzePattern() {
        ...
        // Count odd and even occurrences in recent history
        const oddCount = this.digitHistory.filter(d => d % 2 === 1).length;
        const evenCount = this.digitHistory.length - oddCount;
        ...
        // Always return true since we're only trading odd
        return true;
    }
    ...
    async executeTrade() {
        ...
        // Analyze pattern but always trade odd
        this.analyzePattern();
        ...
        try {
            ...
            if (data.msg_type === 'proposal') {
                ...
                if (data.tick && data.tick.quote) {
                    ...
                    console.log('Current digit:', digit, 'Is Odd:', digit % 2 === 1);
                }
            }
...
module.exports = OddBot;
export default OddBot; 